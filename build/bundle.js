...
/***/ function(module, exports, __webpack_require__) {
	...
	var _completedChallenges = __webpack_require__(27);
	
	var _completedChallenges2 = _interopRequireDefault(_completedChallenges);
	...
	var showCompletedList = function showCompletedList(err, res) {
	  var placeholder = document.getElementById('placeholder2');
	  placeholder2.innerHTML = (0, _completedChallenges2.default)(res.body);
	};
	
	var getCompletedList = function getCompletedList() {
	  var challengeApi = '/getCompleted';
	  _superagent2.default.get(challengeApi).end(showCompletedList);
	};
